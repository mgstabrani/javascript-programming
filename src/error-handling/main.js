 ...
 * bila ada argumen fungsi yang bukan number, alih-alih error,
 * ia akan mengembalikan "Segitiga sembarang".
 * Contoh:
 ...
 *
 *  Tugas Anda adalah memperbaiki fungsi detectTriangle agar
 *  berjalan dengan kondisi yang diharapkan.
 ...
 *
 * TODO 2:
 * - Buatlah fungsi validateNumberInput yang memvalidasi 3 buah input
 *   (argumen) dengan spesifikasi berikut:
 *   - Menerima 3 argumen
 ...
 *
 * TODO 3:
 * - Panggil fungsi validateInputNumber di dalam fungsi detectTriangle
 *     untuk memvalidasi nilai argumen a, b, dan c.
 *   - pastikan Anda memanggil validaateInputNumber menggunakan try .. catch.
 *   - bila block catch terpanggil, kembalikan fungsi detectTriangle dengan
 *     pesan error yang dibawa fungsi validateInputNumber.
 */
